        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutputSnapshotJson = table.Column<string>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietPreferences", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeAllergies", x => new { x.RecipeId, x.AllergyId });
                    table.ForeignKey(
                        name: "FK_RecipeAllergies_Allergies_AllergyId",
                        column: x => x.AllergyId,
                        principalTable: "Allergies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeAllergies_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateTable(
                name: "RecipeDietPreferences",
                columns: table => new
                {
                    RecipeId = table.Column<Guid>(type: "uuid", nullable: false),
                    DietPreferenceId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeDietPreferences", x => new { x.RecipeId, x.DietPreferenceId });
                    table.ForeignKey(
                        name: "FK_RecipeDietPreferences_DietPreferences_DietPreferenceId",
                        column: x => x.DietPreferenceId,
                        principalTable: "DietPreferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeDietPreferences_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDietPreferences", x => new { x.UserId, x.DietPreferenceId });
                    table.ForeignKey(
                        name: "FK_UserDietPreferences_DietPreferences_DietPreferenceId",
                        column: x => x.DietPreferenceId,
                        principalTable: "DietPreferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDietPreferences_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyCalorieTarget = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeAllergies_AllergyId",
                table: "RecipeAllergies",
                column: "AllergyId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeDietPreferences_DietPreferenceId",
                table: "RecipeDietPreferences",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDietPreferences_DietPreferenceId",
